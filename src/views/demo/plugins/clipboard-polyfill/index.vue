<template>
  <container>
    ...
    <el-row :gutter="10">
      <el-col :span="12">
        <div class="d2-mb">
          <el-input v-model="text" style="width: 200px;" />
          <el-button class="d2-ml" @click="copyText()">将左侧输入框内的文字复制进剪贴板</el-button>
        </div>
        <el-button @click="copyHtml()">将 <span v-html="html" /> 连带样式一起复制进剪贴板，然后去 Word 文档内粘贴</el-button>
      </el-col>
      <el-col :span="12">
        <el-alert
          class="d2-mb"
        ...
        <el-input type="textarea" placeholder="在这里检验你的剪贴板 ( text/plain 数据 )" />
      </el-col>
    </el-row>
  </container>
</template>
