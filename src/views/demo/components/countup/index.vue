<template>
  <container type="card" class="page">
    ...
    <el-row :gutter="20">
      ...
      <el-col :span="6">
        <el-card shadow="never" class="d2-card">
          <p slot="title">回调函数</p>
          <div class="group">
            <count-up :end="100" :callback="() => {className = 'end'}" :class="className" />
          </div>
        </el-card>
      </el-col>
      <el-col :span="6">
        <el-card shadow="never" class="d2-card d2-mb-0">
          ...
          <div class="group">
            <count-up :end="end" :callback="update" />
          </div>
        </el-card>
      </el-col>
    </el-row>
