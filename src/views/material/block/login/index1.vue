...
<template>
  <container>
    <div class="login-container">
      <video muted="" autoplay="" loop="" class="img" style="opacity:1"><source type="video/mp4" src="@/assets/video/photographer.mp4"><p>not support!</p></video>
      ...
      <div class="footer"><p>copyright © 研发中心 </p></div>
    </div>
  </container>
</template>
