...
export default {
  ...
  children: [
    ...
    { path: 'store/page', name: 'DemoPlaygroundStorePage', component: _import('demo/playground/store/page'), meta: { ...meta, cache: true, title: '多标签页控制' }},
    ...
    { path: 'page-cache/on', name: 'DemoPlaygroundPageCacheOn', component: _import('demo/playground/page-cache/on.vue'), meta: { ...meta, cache: true, title: '开启缓存' }},
    ...
    { path: 'page-cache/params/:id', name: 'DemoPlaygroundPageCacheParams', component: _import('demo/playground/page-cache/params.vue'), meta: { ...meta, cache: true, title: '带参路由缓存' }, props: true },
    ...
    { path: 'frame/doc', name: 'demo-playground-frame-doc', component: _import('demo/playground/frame/doc'), meta: { ...meta, title: 'vue 中文文档' }}
  ]
}
